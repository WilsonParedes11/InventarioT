        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0">Un panel de roles te permite reunir y visualizar fácilmente datos de roles para optimizar <br>
                        la experiencia de los roles y garantizar la retención de roles.</p>
                </div>
                <div>
        ...
        {{-- <div class="col-lg-12">
            <form action="{{ route('customers.index') }}" method="get">
                <div class="d-flex flex-wrap align-items-center justify-content-between">
                    ...
                    <div class="form-group row">
                        <label class="contro@extends('dashboard.body.main')
...
@endsection
l-label col-sm-3 align-self-center" for="search">Buscar:</label>
                        <div class="col-sm-8">
                            <div class="input-group">
