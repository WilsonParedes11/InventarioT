...
<div class="container-fluid mb-3">
    ...
    <div class="row px-3">
        ...
        <div class="container-fluid mb-3">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card car-transparent">
                        <div class="card-body p-0">
                            <div class="profile-image position-relative">
                                <img src="{{ asset('assets/images/page-img/profile.png') }}" class="img-fluid rounded h-30 w-100" alt="imagen-de-perfil">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row px-3">
                <!-- Comienzo: Detalle Izquierdo del Empleado -->
                <div class="col-lg-4 card-profile mb-5 h-50">
                    <div class="card card-block card-stretch card-height mb-5">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-3">
                                <div class="profile-img position-relative">
                                    <img src="{{ $employee->photo ? asset('storage/employees/' . $employee->photo) : asset('assets/images/user/1.png') }}" class="img-fluid rounded avatar-110" alt="imagen-de-perfil">
                                </div>
                                <div class="ml-3">
                                    <h4 class="mb-1">{{ $employee->name }}</h4>
                                    <p class="mb-2">Diseñador UI/UX</p>
                            ...
                            <ul class="list-inline p-0 m-0">
                                ...
                                <li class="mb-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p class="mb-0">{{ $employee->city ? $employee->city : 'Desconocido' }}</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <!-- Fin: Detalle Izquierdo del Empleado -->
        
                <!-- Comienzo: Detalle Derecho del Empleado -->
                ...
                <!-- Fin: Detalle Derecho del Empleado -->
            </div>
        </div>
        @endsection
          <div class="col-lg-4 card-profile mb-5 h-50">
