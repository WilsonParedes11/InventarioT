...
function showFileName() {
    ...
    // El evento change nos da el elemento de entrada en el que ocurrió
    const srcFile = input.srcElement;

    // El input tiene un array de archivos en la propiedad `files`, cada uno tiene un nombre que puedes usar. Aquí estamos usando solo el nombre.
