              ...
              <div class="p-3">
                ...
                <form action="{{ route('login') }}" method="POST">
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="floating-label form-group">
                        <input
                          ...
                          value="{{ old('input_type') }}" autocomplete="off"
                          required autofocus>
                        <label>Correo electrónico/nombre de usuario</label>
                      </div>
                      @error('username')
                        <div class="mb-4" style="margin-top: -20px">
                          <div class="text-danger small">Nombre de usuario
                            incorrecto o
                            contraseña.</div>
                        </div>
                      @enderror
                    ...
                    <div class="col-lg-6">
                      <p>
                        ¿No eres miembro todavía? <a
                          href="{{ route('register') }}"
                          class="text-primary">Registrarse</a>
                      </p>
                    </div>
                    <div class="col-lg-6">
                      <a href="#" class="text-primary float-right">Olvidó su
                        ¿Contraseña?</a>
                    </div>
                  </div>
                  <button type="submit"
