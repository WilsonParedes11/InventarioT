        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0">Un panel de historial de pagos de salario te permite reunir y visualizar fácilmente datos de historial de pagos de salario optimizando la experiencia, garantizando la retención de historial de pagos de salario.</p>
                </div>
                <div>
                ...
                <table class="table mb-0">
                    ...
                    <tbody class="ligth-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="btn btn-success text-white mr-2">Total Pagado</span>
                            </td>
                            <td>
                                <form action="{{ route('pay-salary.destroy', $paySalary->id) }}" method="POST">
                                    ...
                                    <div class="d-flex align-items-center list-action">
                                        <a class="btn btn-info mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Historial" href="{{ route('pay-salary.payHistoryDetail', $paySalary->id) }}">
